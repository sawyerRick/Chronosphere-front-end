<template>
  <div>
    <p>Chronosphere page with {{someData}}</p>
    ...
    <div id="main-container">
      ...
      <div id="chatting-room-container" >
          <form id="chat-form" style="padding: 10px">
              <input type="text" id="msg" size="30" autocomplete="off"/>
...
export default {
    data() {
      return {
        someData: "someDatasomeDatasomeDatasomeData",
        options: {
